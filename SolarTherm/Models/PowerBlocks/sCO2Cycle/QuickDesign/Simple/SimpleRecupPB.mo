within SolarTherm.Models.PowerBlocks.sCO2Cycle.QuickDesign.Simple;
  ...
  model SimpleRecupPB "This model calculates a few off-design points as initial equation and after interpolate over them"
      ...
      SolarTherm.Models.PowerBlocks.sCO2Cycle.QuickDesign.Simple.Turbine turbine(eta_design = eta_turb, PR = PR, N_points = N_points) annotation(
      ...
      SolarTherm.Models.PowerBlocks.sCO2Cycle.QuickDesign.Simple.HeatRecuperatorDTAve HTR(N_points = N_points, N_q = N_HTR, pinchRecuperator = pinchHTR, ratio_m_des = 1, P_nom = P_nom) annotation(
        Placement(visible = true, transformation(origin = {-2, -2}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      SolarTherm.Models.PowerBlocks.sCO2Cycle.QuickDesign.Simple.CompressorOnShaft compr(eta_design = eta_comp, PR = PR, N_points = N_points) annotation(
