...
model PowerBlockModel_2
  ...
  Real load;
  SI.HeatFlowRate W_gross "Gross power";
...
equation
  ...
  Ex_out=-fluid_b.m_flow*((fluid_b.h_outflow-h_dead)-T_amb*(s_out-s_dead));
  
 -W_net+Ex_in-Ex_out-Ex_des=0;
 der(Ex_loss)=Ex_des;

end PowerBlockModel_2;
